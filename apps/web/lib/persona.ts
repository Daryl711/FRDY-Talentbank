// Animal Persona quiz - data + scoring. Ported from the mobile app
// (apps/mobile/src/data/persona.ts) so the web candidate portal runs the same
// 40-question assessment and shows the same animal archetypes.
